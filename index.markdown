					...
					<div id="main">
						...
						<!-- Featured Post -->
							<article class="post featured">
								...
								<a href="generic.html" class="image main"><img src="![image of post1](https://github.com/PinkClouds8-bit/PinkClouds8-bit.github.io/blob/master/post2.jfif?raw=true)" alt="" /></a>
